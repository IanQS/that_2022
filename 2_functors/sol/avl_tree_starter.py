...
"""
As you'll see in a sec, we're going to end up changing this for our day_3
    implementation where we introduce the idea of functors
"""
...
class _TreeNode(object):
    def __init__(self, key, ihm_data):
        self.key = key
        self.left = None
        self.right = None
        self.height = 1
